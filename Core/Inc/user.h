...
#define PWM_CCR_MIN			(PWM_MIN_PULSEWIDTH / 1000 * PWM_FREQUENCY) * PWM_TIM_ARR - 1 //719
#define PWM_CCR_DEFAULT		(PWM_ZERO_PULSEWIDTH / 1000 * PWM_FREQUENCY) * PWM_TIM_ARR - 1 // 1079
#define PWM_CCR_MAX      	(PWM_MAX_PULSEWIDTH / 1000 * PWM_FREQUENCY) * PWM_TIM_ARR - 1 // 1439
